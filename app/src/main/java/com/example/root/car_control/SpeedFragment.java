...
public class SpeedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GraphView graph = (GraphView) rootView.findViewById(R.id.speedGraph);

        graph.setTitle("Live Speed Diagram");
    ...
    public void onResume() {
        ...
        mTimer2 = new Runnable() {
            ...
            public void run() {
                graph2LastXValue += 1d;
                mSeries2.appendData(new DataPoint(graph2LastXValue, getLiveSpeed()), true, 40);
