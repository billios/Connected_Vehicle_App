...
public class TemperatureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GraphView graph = (GraphView) rootView.findViewById(R.id.temperatureGraph);

        graph.setTitle("Live Coolant Temperature Diagram");
        ...
        graph.getGridLabelRenderer().setLabelFormatter(new DefaultLabelFormatter() {
            ...
            public String formatLabel(double value, boolean isValueX) {
                if (isValueX) {
                    ...
                    return super.formatLabel(value, isValueX) + " Celcius";
                }
            }
        });
    ...
    public void onResume() {
        ...
        mTimer2 = new Runnable() {
            ...
            public void run() {
                graph2LastXValue += 1d;
                mSeries2.appendData(new DataPoint(graph2LastXValue, getLiveTemperature()), true, 40);
